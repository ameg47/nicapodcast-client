...
export default function Post({
  ...
  return (
    <div className="mx-4 my-2 pt-8 pb-2 bg-white rounded shadow-lg">
      ...
      <div className="h-full px-8 mb-4 flex flex-col content-around">
        <h2 className="text-xl mt-4 mb-4 h-16">{title}</h2>
